    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            trafficLightManager.AddTrafficLiht(trafficLight2);
                ...
                AutomobileTrafficLight trafficLight3 = new AutomobileTrafficLight(27, 7, 29, 7, 31, 7);
                AutomobileTrafficLight trafficLight4 = new AutomobileTrafficLight(27, 12, 29, 12, 31, 12);
